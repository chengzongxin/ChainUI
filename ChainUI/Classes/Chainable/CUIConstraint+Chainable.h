 ...
 */
#define Constraint(view1)       [[CUIConstraint alloc] initWithFirstItem:view1]

NS_ASSUME_NONNULL_BEGIN

@interface CUIConstraint (Chainable)
 ...
 */
CUI_CONSTRAINT_PROP(FloatList)  multipliers;
 ...
 */
CUI_CONSTRAINT_PROP(FloatList)  constants;
 ...
 */
CUI_CONSTRAINT_PROP(Object)     view;

/**
 * Setting priority value, default: UILayoutPriorityRequired (1000).
 * Usages: .priority(900)
 */
CUI_CONSTRAINT_PROP(Float)      priority;

/**
 * Setting identifier value.
 * Usages: .identifier(@"top constraint")
 */
CUI_CONSTRAINT_PROP(Object)     identifier;

#define multipliers(...)        multipliers(CUI_MAKE_FLOAT_LIST(__VA_ARGS__))
#define constants(...)          constants(CUI_MAKE_FLOAT_LIST(__VA_ARGS__))
...
/**
 * CUIConstraintMaker support an Masonry like way of making constraints.
...
@interface CUIConstraintMaker (CUIChainable)

- (CUIConstraint *)left;
- (CUIConstraint *)right;
- (CUIConstraint *)top;
- (CUIConstraint *)bottom;
- (CUIConstraint *)leading;
- (CUIConstraint *)trailing;
- (CUIConstraint *)width;
- (CUIConstraint *)height;
- (CUIConstraint *)centerX;
- (CUIConstraint *)centerY;
- (CUIConstraint *)baseline;
- (CUIConstraint *)firstBaseline;

- (CUIConstraint *)leftMargin;
- (CUIConstraint *)rightMargin;
- (CUIConstraint *)topMargin;
- (CUIConstraint *)bottomMargin;
- (CUIConstraint *)leadingMargin;
- (CUIConstraint *)trailingMargin;
- (CUIConstraint *)centerXWithinMargins;
- (CUIConstraint *)centerYWithinMargins;
