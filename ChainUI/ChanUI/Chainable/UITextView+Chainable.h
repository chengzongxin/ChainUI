...
@interface UITextView (Chainable)
 ...
 */
CUI_TV_PROP(Object)     color;

/**
 * Setting the max length that are allow to input.
 * Usages: .maxLength(20)
 */
CUI_TV_PROP(Int)        maxLength;
