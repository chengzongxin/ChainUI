...
- (void)setupUI {
    _indexLabel = Label.fnt(17).txtColor(@"darkGray").fixWidth(44).centerAlignment;
    ...
    _categoryLabel = Label.fnt(13).txtColor(@"darkGray");
    
    _ratingLabel = Label.fnt(11).txtColor(@"orange");
    _countLabel = Label.fnt(11).txtColor(@"darkGray");
    ...
    _iapLabel = Label.fnt(9).txtColor(@"darkGray").lines(2).str(@"In-App\nPurchases").centerAlignment;
    ...
    HorStack(
             ...
             midStack,
             CUISpring,     //Using spring to ensure actionStack stay in the right most position.
             actionStack
